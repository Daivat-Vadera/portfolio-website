...
import HeroBannerImage from "../../public/PW_Hero_Banner_Image.svg";
const HeroBanner = () => {
  return (
    <section className="mt-[112px]" id="home">
          ...
          <div className="flex items-center justify-center flex-col lg:flex-row px-8">
            <div className="w-full lg:w-5/12 order-2 lg:order-1 mt-12 lg:mt-0">
              ...
              <p className="description text-base font-normal text-zinc-500 mt-8">
                I'm Daivat Vadera Lorem Ipsum is simply dummy text of the
              ...
              <div className="flex items-center justify-start gap-4 mt-4">
                ...
                <div className="github-icon">
                  <a href="https://github.com/Daivat-Vadera" target="_blank">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 640 640"
                      height={48}
