        ...
        <div className="container mx-auto px-8">
          ...
          <div className="content-wrap mt-5 py-5">
            <div className="skill-wrap flex justify-center items-center flex-wrap flex-row gap-8 lg:gap-16 xl:gap-20">
              {skills.map((skill) => (
                <div key={skill.name} className="skill-item lg:w-[16%] w-[43%] sm:w-[30%] p-6 flex flex-col items-center rounded border-2 border-black hover:bg-black hover:border-black hover:text-white transition-all duration-300 group">
